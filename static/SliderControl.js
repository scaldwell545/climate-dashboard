L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append('<div id="leaflet-slider" style="width:400px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:13px; background-color:#FFFFFF; text-align:center; border-radius:5px;"></div></div>');
